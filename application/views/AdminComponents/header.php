...
<html>
  <head>
    ...
    <link rel="stylesheet" href="/css1/amchart.css">
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-lg"><b>Adora</b>Panel</span>
        </a>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      ...
                      <small>Member since 10th Aug 2015</small>
                    </p>
                  </li>
                  <!-- Menu Body -->
                  <li class="user-body">
                  ...
                  <li class="user-footer">
                    <div class="pull-left">
                      <a href="<?php echo site_url('welcome/changeAdminProfile'); ?>" class="btn btn-default btn-flat">Profile</a>
                    </div>
