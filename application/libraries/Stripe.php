...
class Stripe {
	...
	public function __construct() {
		...
		$config['stripe_key_test_public']         = 'pk_test_gk00QWyRqVTFZYuGvLc6A0Fm';
		$config['stripe_key_test_secret']         = 'sk_test_XCQe30oCaM1D46ACbZGVmOoT';
		$config['stripe_key_live_public']         = 'pk_live_74AhJYIpMzbmzcBXK9EUi9F5';
		$config['stripe_key_live_secret']         = 'sk_live_X3mrslqFnkHIpPuHq58lfIHF';
